...
function jcdatetimechoose(){
	...
	if(jcdatePram.time=="only"){
        ...
        var newDay = jcdatePram.nowdate.substring(jcdatePram.nowdate.lastIndexOf("-")+1,jcdatePram.nowdate.length);
        if (newDay == 'undefined' || newDay == '' || newDay == null){
            var d = new Date();
            jcdatePram.nowdate = jcdatePram.nowdate.substring(0,jcdatePram.nowdate.indexOf("undefined"));
            jcdatePram.nowdate = jcdatePram.nowdate.concat(d.getDate().toString());
