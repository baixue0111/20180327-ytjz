...
//任务名称
function taskName() {
    var url = "/assist/task/taskTypeList2";
    var request = {
        param: {},
        common_param: {
            "token": token,
            ...
            if (data == "" || data == undefined || data == null || data == "undefined") {
                ...
                if (data.error.code == 1) {
                    ...
                    $.each(data.data.taskList, function(z, y) {
                        ...
                        if (y.initialName == null) {
                            initialName = "无"
                        }
                        var str1 = '<li class="shensdas">' +
                            '<div><span class="title" title="' + initialName + '">' + initialName + '</span></div>' +
                            ...
                            '<div style="width:8%;"><span><a href="information.html?ha=' + y.id + '" target="view_window"><div class="xaing1" style="width: 34px;">详情</div></a></span></div>' +
                            '</li>';
    ...
    $.ajax({
        ...
        success: function(data) {
            if (data == "" || data == undefined || data == null || data == "undefined") {
                ...
                alert('恭喜您！共抢到' + data.data.robJobNum + '条工单')
            } else {
