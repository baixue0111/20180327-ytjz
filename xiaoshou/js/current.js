            ...
            if (data == "" || data == undefined || data == null || data == "undefined") {
                ...
                if (data.error.code == 1) {
                    var workorderStr = '<li id="workorder">' +
                        ...
                        '<div style="width:14%;"><span>用户归属</span></div>' +
                        ...
                        '<div style="width:10%;"><span>操作</span></div>' +
                        '</li>';
                    ...
                    $.each(data.data.taskList, function(z, y) {
                        ...
                        var str1 = '<li class="shensdas">' +
                            ...
                            '<div style="width:14%"><span class="title" title="' + a[0] + '" style="display:block;white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">' + a[0] + '</span></div>' +
                            '<div><span class="title" title="' + a[6] + '">' + a[6] + '</span></div>' +
                            '<div id="name_' + y.id + '"><span class="title" title="' + informationShow + '">' + a[7] + '</span></div>' +
                            '<div id="staus_' + y.id + '" style="width: 8.6%;"><span class="title" title="' + informationShow + '" style="display:block;white-space:nowrap; overflow:hidden; text-overflow:ellipsis;">' + y.accNbr + '</span></div>' +
                            ...
                            '<div style="width:10%;"><span>' + operatorStr + '</span></div>' +
                            '</li>';
