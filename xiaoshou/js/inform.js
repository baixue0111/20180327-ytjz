 ...
 */
//获取地址栏
var offerId, planId, prodNumList, contact1, accnbr, corelinkman, editSms, initialSalesId, urlWebTakeInfo;
...
/**
 * 判断cta =2可以点击  编辑术语、保存术语，外呼，编辑短信等等按钮
 * ！=2 添加disabled 属性
 */

if (cta == 2) {
    urlWebTakeInfo = "/assist/task/webTakeInfo";
    $('.butDisabled').attr("disabled", false);
} else if (cta == 3) { // 历史工单详情
    urlWebTakeInfo = "/assist/task/webTakeInfo2";
    $('.butDisabled').attr("disabled", true);
    $('.butDisabled').css("backgroundColor", "#a9aaad");
    $('.butDisabled').css("color", "#251e1e");
} else {
    urlWebTakeInfo = "/assist/task/webTakeInfo";
    $('.butDisabled').attr("disabled", true);
    $('.butDisabled').css("backgroundColor", "#a9aaad");
            ...
            if (data == "" || data == undefined || data == null || data == "undefined") {
                ...
                if (data.error.code == 1) {
                    ...
                    if (task != null) {
                        ...
                        initialSalesId = task.initial_sales_id;
                        //用户行为信息
        ...
        success: function(data) {
            ...
            if (data.error.code == 1) {
                ...
                if (data.data.taskJobRecordList == "") {
                    $("#liuzhuan").html('<p style="width: 100%;height: 100px;float: left;text-align: center;line-height: 100px; border-bottom: 1px dashed #000;">该工单暂无流转记录</p>');
                } else {
                    ...
                    $.each(data.data.taskJobRecordList, function(i, item) {
                        ...
                        var liuStr = '<li class="liu">' +
                            ...
                            '</li>';
                        $("#liuzhuanUl").append(liuStr);
                        // $("#liuzhuanUl").css("border-bottom", "1px dashed #000");
