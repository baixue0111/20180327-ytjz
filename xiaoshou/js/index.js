...
//function grabASingle() {
//    document.getElementById("iframe").src = 'grabASingle.html?token=' + token + '&salesId=' + salesId + '';
//}
...
function turnRetrieve() {
    ...
    var request = {
        param: {
            ...
            "isRobJob": person.isRobJob,
            "contractInvalidTime": person.contractInvalidTime,
                ...
                if (data.error.code == 1) {
                    ...
                    $.each(data.data.managers, function(z, y) {
                        ...
                        var sendeestr = '<ul class="souming">' +
                            ...
                            '<div>' + c[1] + '</div>' +
                            '</li>' +
                            '<li class="shiju" title="' + c[2] + '">' + c[2] + '</li>' +
