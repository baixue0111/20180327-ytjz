...
phone = $.cookie("phoneno");

$(function(){
    if(productId == "" || productId == "null" || productId == null || productId == undefined || phone == "" || phone == null || phone == undefined){
        return;
    } else {
        tj_message(); //推荐机型信息
        ownModel();   // 用户机型信息
...
function manufacturerList(){
    ...
    var url = "/model/manufacturerList";
    $.ajax({
        url:url1,
        type:"post",
...
function modelVersionList(change_cs){
    ...
    var url = "/model/modelVersionList";
