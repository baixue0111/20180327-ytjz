/**
 * Created by hsgeng on 2016/11/01.
 */
...
//倒计时
var tEnd = new Date(2016,11,15,24,00,00);
function move(){
    var tStart = new Date();
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.status==0){
                ...
                $('#successMessage').html('<p class="success"><span class="success2">恭喜您,</span>成功抢购“10元1G三天包”,系统将在24小时内为您受理,受理结果将通过短信进行告知.感谢您的参与!</p>');
            }
        },
        error:function(){
            $('#errorMessage').html("服务器连接失败！");
