...
//				    debug: true, // 开启调试模式,调用的所有api的返回值会在客户端alert出来，若要查看传入的参数，可以在pc端打开，参数信息会通过log打出，仅在pc端时才会打印。
                ...
                wx.ready(function (){ 
					wx.onMenuShareTimeline({
					    ...
					    link: 'http://gz.mobicloud.com.cn/active/gzQRcode/codeb.html?openId='+openId+'&phone='+phone+'', // 分享链接
					    imgUrl: 'http://gz.mobicloud.com.cn/active/gzQRcode/img/sty.png', // 分享图标
					    success: function () { 
					        // 用户确认分享后执行的回调函数
					        alert('分享成功');
					        shareSta();
	...
	//				分享给朋友
					wx.onMenuShareAppMessage({
					    imgUrl: "http://gz.mobicloud.com.cn/active/gzQRcode/img/sty.png",//分享图，默认当相对路径处理，所以使用绝对路径的的话，“http://”协议前缀必须在。
					    desc: "关注并绑定“中国电信贵州加油站”，免费领100M",//摘要,如果分享到朋友圈的话，不显示摘要。
...
function shareSta(){
	...
	var shareUrl='https://open.weixin.qq.com/connect/oauth2/authorize?appid=wx9f4355fc38716ace&redirect_uri=http://gz2.mobicloud.com.cn/active/gzQRcode/indexb.html&response_type=code&scope=snsapi_base&state=123#wechat_redirect';
	var openId=GetQueryString('openId');
	var phone=GetQueryString('phone');
	var param={};
	param["openId"]=openId;
