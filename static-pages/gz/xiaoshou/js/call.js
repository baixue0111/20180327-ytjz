 ...
 */
function register() {
  if ( hqpassword != null|| hqseatid != null|| hqdomain != null|| hqcompanyid != null){
    begin();
  }else {
    //var username = sessionStorage.getItem("salesId");
     var username = initialSalesId;
...
function recordingRecord() {
  ...
  $.ajax({
    type: 'get',
    url: url,
    data: { 'companyid': hqcompanyid, 'seatid': initialSalesId, 'phone': uril, 'source': "GZ" },
    success: function (data) {
    }
  });
}
