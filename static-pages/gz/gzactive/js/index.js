...
function login(){
    var str='<div class="load"></div>'+
        ...
        '</div><div style="color:#f4f4f4;font-size: 16px"><p>仅2016年2月1日至2月22日开放订购</p></div>'+
        '</div>';
    $("#loginStr").html(str);
}
function clearError(){
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.status==0){
                ...
                $('#successMessage').html('<p class="success">恭喜您成功抢购"春节7天包", 系统将在24小时内为您进行受理, 受理结果将通过短信进行告知。感谢您的参与！</p>');
