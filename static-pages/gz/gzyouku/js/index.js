...
function validateInfo(btn) {
    var url="/activity/youkuorder/send";
...
/*订购*/
function loginInfo() {
    var url="/activity/youkuorder/order";
    var phone= $("#phoneNum").val();
    var productcd="700012209";
    ...
    $.ajax({
        ...
        success: function(data){
            ...
            if(data.status==0){
                ...
                $('#successMessage').html('<p class="success">恭喜您成功抢购“20元1G省内优酷定向流量包”并获得150M省内免费流量，系统将在24小时内为您受理，受理结果将通过短信进行通知。感谢您的参与！</p>');
            }
        },
        error:function(){
            $('#errorMessage').html("服务器连接失败！");
